    ...
    <>
      <div className="flex w-full justify-between items-center h-20 px-4 absolute right-7 z-10">
        <Link to="/" onClick={refreshPage}>
          <div>
            <h1
              className={`text-3xl lg:text-4xl ml-8 pl-5 lg:pl-3 font-semibold cursor-pointer font-fornavbar ${props.fontcolor}`}
            >
              Minder 💋
            </h1>
          </div>
        ...
        <ul className="hidden lg:font-semibold lg:flex">
          <Link to="/" onClick={refreshPage}>
            <li
              className={`p-4 text-xl cursor-pointer ${props.fontcolor} font-bold`}
            >
              Home
            </li>
          </Link>
