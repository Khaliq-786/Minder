      ...
      <section class="bg-gradient-to-br from-red-50 via-red-100 to-yellow-200 min-h-screen flex items-center justify-center">
        ...
        <div className="bg-gradient-to-br from-red-150 via-red-150 to-yellow-50 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center mt-20 mb-10">
          ...
          <div className="md:w-1/2 px-8 md:px-16">
            <h2 className="font-bold text-2xl text-red-400 ">Sign Up</h2>
            <p className="text-xs mt-4 text-red-300">
              New to Minder ,easily sign up
            </p>
            ...
            >
              ...
              <div className="relative">
                ...
                <svg
                  ...
                  height="16"
                  fill="gray"
                  className="bi bi-eye absolute top-5 right-3 -translate-y-1/2 cursor-pointer "
                  viewBox="0 0 16 16"
                >
              ...
              <div className="relative">
                ...
                <svg
                  onClick={() => {
                    //Enable show password functionaltiy
                    let psswd = document.getElementById("confirmpassword");
                    psswd.type =
                      psswd.type === "password" ? "text" : "password";
                  }}
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="flex items-start">
                ...
                <label
                  htmlFor="pnc-check"
                  className="ml-2 text-sm font-extralight text-red-300 cursor-poi dark:text-gray-300"
                >
            ...
            <div className="mt-5 text-xs border-b border-red-500 py-4 text-red-300">
              <Link to="/ForgotPass">Password Guidelines</Link>
